...
app.put("/repositories/:id", (request, response) => {
  ...
  title && Object.assign(updateRepository, { title });
  url && Object.assign(updateRepository, { url });
  techs && Object.assign(updateRepository, { techs });
...
app.post("/repositories/:id/like", (request, response) => {
  ...
  let likes = repositories[repositoryIndex].likes ?? 0;
  likes += 1;
